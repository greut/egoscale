...
// NewClient returns a new Exoscale Compute API client, configured to use apiKey and apiSecret as API credentials and
// apiEndpoint as an alternative Compute API endpoint URL. If tracing is true, the outgoing API calls and received
